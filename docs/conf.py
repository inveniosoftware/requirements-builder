...
# -*- coding: utf-8 -*-
#
# requirements-builder documentation build configuration file, created by
...
html_theme_options = {
    ...
    'github_repo': 'requirements-builder',
    'github_button': False,
    'github_banner': True,
    'show_powered_by': False,
    'extra_nav_links' : {
        'requirements-builder@GitHub' : 'http://github.com/inveniosoftware/requirements-builder/',
        'requirements-builder@PyPI' : 'http://pypi.python.org/pypi/requirements-builder/',
    }
}
...
htmlhelp_basename = 'requirements-builderdoc'
